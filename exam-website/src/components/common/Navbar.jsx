...
export default function Navbar({ showNavPills = true, customLeftContent, customRightContent }) {
    ...
    <>
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/80 transition-all">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          {/* 🌟 ส่วนซ้ายสุด (รองรับ Custom จากหน้าข้อสอบ) */}
          ...
          {/* 🌟 ส่วนตรงกลาง (รองรับการซ่อนเมื่ออยู่หน้าข้อสอบ) */}
          {showNavPills && (
          ...
          {/* 🌟 ส่วนขวาสุด (รองรับ Custom จากหน้าข้อสอบ) */}
          ...
          <div className="flex md:hidden items-center gap-2">
            {(role === 'creator' || role === 'admin') && !customRightContent && (
              <Link
                to="/admin"
